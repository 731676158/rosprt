...
(cl:defmethod cl:initialize-instance :after ((m <Addints-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Addints-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name demo_02-srv:<Addints-request> is deprecated: use demo_02-srv:Addints-request instead.")))

(cl:ensure-generic-function 'num1-val :lambda-list '(m))
(cl:defmethod num1-val ((m <Addints-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader demo_02-srv:num1-val is deprecated.  Use demo_02-srv:num1 instead.")
  (num1 m))

(cl:ensure-generic-function 'num2-val :lambda-list '(m))
(cl:defmethod num2-val ((m <Addints-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader demo_02-srv:num2-val is deprecated.  Use demo_02-srv:num2 instead.")
  (num2 m))
...
(cl:defmethod cl:initialize-instance :after ((m <Addints-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Addints-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name demo_02-srv:<Addints-response> is deprecated: use demo_02-srv:Addints-response instead.")))

(cl:ensure-generic-function 'sum-val :lambda-list '(m))
(cl:defmethod sum-val ((m <Addints-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader demo_02-srv:sum-val is deprecated.  Use demo_02-srv:sum instead.")
  (sum m))
